...
class LeaderboardGroomside extends StatefulWidget {
  const LeaderboardGroomside({Key? key}) : super(key: key);

  @override
  State<LeaderboardGroomside> createState() => _LeaderboardGroomsideState();
}

class _LeaderboardGroomsideState extends State<LeaderboardGroomside> {
  @override
  void initState() {
    super.initState();
    Future.delayed(const Duration(milliseconds: 0)).then((value) {
      context.read<LeaderboardProvider>().getLeaderboard(
          marriage_id: sharedPrefs.marriageId, guest_from: 'groom_side');
    });
  }
